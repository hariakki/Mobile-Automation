...
public class ReadExcelSheet {
	 ...
	 * @param colName
	 * @param rowNum
	 * @return Integer Data in a Particular cell
	 */
	public String getDataByColName(String sheetName, String colName, int rowNum) {
		try {
			if (rowNum <= 0)
				return "";
			...
			if (cell == null)
				return "";
			System.out.println("Cell data type is : " + cell.getCellStyle());
			if (cell.getCellType() == Cell.CELL_TYPE_STRING)
				...
				System.out.println(" Cell data is : " + cellText);
				return cellText;
			...
			System.out.println(
					"row " + rowNum + " or column " + colName + " does not exist in xls" + " " + e.getMessage());
